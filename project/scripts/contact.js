...
form.addEventListener('submit', (e) => {
  ...
  if (isValid) {
    ...
    formStatus.innerHTML = `
      <p class="subtitle">Message sent successfully at ${new Date().toLocaleTimeString()}</p>
      <p class="subtitle">Thanks for your submission ${storedData[storedData.length - 1].name}</p>
    `;
